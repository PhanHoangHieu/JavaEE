							...
							<tbody>
								<tr>
									<td class="shoping__cart__item"><img
										src="<c:url value='/template/web/img/cart/cart-1.jpg' />" alt="">
								...
								<tr>
									<td class="shoping__cart__item"><img
										src="<c:url value='/template/web/img/cart/cart-2.jpg' />" alt="">
								...
								<tr>
									<td class="shoping__cart__item"><img
										src="<c:url value='/template/web/img/cart/cart-3.jpg' />" alt="">

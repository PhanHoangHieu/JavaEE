					...
					<div class="product__details__pic">
						...
						<div class="product__details__pic__slider owl-carousel">
							<img data-imgbigurl="<c:url value='/template/web/img/product/details/product-details-2.jpg' />"
								src="<c:url value='/template/web/img/product/details/thumb-1.jpg' />" alt=""> <img
								data-imgbigurl="<c:url value='/template/web/img/product/details/product-details-3.jpg' />"
								src="<c:url value='/template/web/img/product/details/thumb-2.jpg' />" alt=""> <img
								data-imgbigurl="<c:url value='/template/web/img/product/details/product-details-5.jpg' />"
								src="<c:url value='/template/web/img/product/details/thumb-3.jpg' />" alt=""> <img
								data-imgbigurl="<c:url value='/template/web/img/product/details/product-details-4.jpg' />"
